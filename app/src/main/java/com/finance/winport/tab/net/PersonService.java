...
public interface PersonService {
    ...
    Observable<ScanShopList> getCollectionList(@Body HashMap<String, Object> params);
    ...
    Observable<AppointStatistics> getAppointStatistics(@Body HashMap<String, Object> params);
