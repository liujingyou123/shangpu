 ...
 * Created by xzw
 */
public abstract class PullRecyclerBaseAdapter<E> extends RecyclerView.Adapter {
    ...
    public PullRecyclerBaseAdapter(PtrClassicFrameLayout baseView, List<E> baseData, int maxTotal) {
        if (baseView == null) {
