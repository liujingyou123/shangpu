...
public class PtrFrameLayout extends ViewGroup {
    ...
    public PtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (arr != null) {
            ...
            refreshEnable = arr.getBoolean(R.styleable.PtrFrameLayout_ptr_refresh_enable, refreshEnable);
            arr.recycle();
        }
    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if ((moveUp && canMoveUp) || (moveDown && refreshEnable)) {
                    movePos(offsetY);
                    return true;
                }
    ...
    private OnScrollBottomListener onScrollBottomListener = new OnScrollBottomListener() {
        ...
        public void onScrollStateChanged(AbsListView listView, int scrollState) {
            if (mOnScrollLisenter != null) {
                mOnScrollLisenter.onScrollStateChanged(listView,scrollState);
            }
        }
        ...
        public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
            if (mOnScrollLisenter != null) {
                mOnScrollLisenter.onScroll(view, firstVisibleItem, visibleItemCount, totalItemCount);
            }
        }
    };
    ...
    OnScrollLisenter mOnScrollLisenter;

    public void setOnScrollListener(OnScrollLisenter onScrollLisenter) {
