...
import com.finance.winport.view.picker.engine.LoadEngine;
...
public final class Picker {
    ...
    public Picker titleColor(String titleColor) {
    ...
    public void forResult(int requestCode) {
        ...
        intent.putExtra(ImageSelectActivity.COLOR_TITLE, titleColor);
