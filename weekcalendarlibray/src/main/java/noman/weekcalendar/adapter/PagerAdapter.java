...
import static noman.weekcalendar.fragment.WeekFragment.TAGDATE;
...
public class PagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        Log.e("pageAdapter","pageAdapter");
        WeekFragment fragment = new WeekFragment();
        Bundle bundle = new Bundle();
        if(nowDays !=null){
            bundle.putSerializable(TAGDATE,nowDays);
        }
...
//        Log.e("num", NUM_OF_PAGES+"");
    ...
    private DateTime getSelectedDate(){return  date;}
